...
//get_header(); ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="champs-persos">
			...
			$realisateur = get_post_meta($post->ID, 'Réalisation', true);
			$acteurs = get_post_meta($post->ID, 'Interprétation', true);
			...
			?>
			<div class="champs-personalisable">
			...
			<?php if(false === empty($type)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”>Type : </i>
			<?php echo $type ?></span>
			<?php endif; ?>
			</div>
